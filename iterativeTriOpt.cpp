...
bool numScheme( Mesh< MeshConfig, Devices::Host >& mesh, const std::string& fileName )
{
    ...
    for( int iter = 0; iter < 100000; iter ++ )
    {
        ...
        //std::cout << "Cells: " << cellsCount << ", faces: " << facesCount << ", vertices: " << verticesCount << "\n";
        ...
        {
            mesh.getPoints()[ i ] -= 1e-11 * minFace * maxNorm * nabla_mesh[ i ];
        };
        ...
        if( improvement < 0.0 )
        {
            std::cout << "Improvement stopped at iteration " << iter << "\n";
            break;
        }

        // writing the updated mesh into a new file if it improved
